 ...
 * Invoices Model
 *
 * @property \App\Model\Table\BillboardsHiredTable|\Cake\ORM\Association\BelongsTo $BillboardsHired
 *
...
class InvoicesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('BillboardsHired', [
            'foreignKey' => 'billboard_hire_id',
            'joinType' => 'INNER'
        ]);
    }
    ...
    {
        $rules->add($rules->existsIn(['billboard_hire_id'], 'BillboardsHired'));
