...
class FilesFixture extends TestFixture
{
    ...
    public $fields = [
        'file_id' => ['type' => 'integer', 'length' => 12, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-10-10 04:45:55',
                'modified' => '2018-10-10 04:45:55',
                'status' => 1
            ],
        ];
        parent::init();
